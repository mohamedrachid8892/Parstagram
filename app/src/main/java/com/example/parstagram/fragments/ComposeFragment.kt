...
class ComposeFragment : Fragment() {
    ...
    // Tell the fragment which layout file to use
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivPreview = view.findViewById(R.id.ivPostPicture)
        pb = view.findViewById(R.id.pbLoading)
        descriptionField = view.findViewById(R.id.etDescription)
        submitButton = view.findViewById(R.id.btnSubmit)
        takePictureButton = view.findViewById(R.id.btnTakePicture)

        // Set on-click listeners and handle and set up logic
        ...
        submitButton.setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Log.e(MainActivity.TAG, "Error submitting post. File is empty")
                Toast.makeText(requireContext(), "Error submitting post. You didn't take a photo!", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Something went wrong saving your post!", Toast.LENGTH_SHORT).show()
            } else {
                Log.i(MainActivity.TAG, "Post saved successfully")
